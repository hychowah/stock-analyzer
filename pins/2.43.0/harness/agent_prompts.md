...
**5b — decision reopen (orchestrator lead, after Phase 2.5):** Load RESEARCH_AGENTS.md §8 **5b** (`stress_bind`, material duration, `roc_screen_rebuttal`). Edit `decision.json` only. Do not rewrite FV. Do not spawn subagent `5` in `2_5`. Optional handoff `S/registry/handoffs/5b_decision_reopen.md`.
