...
from scripts.kd_research.annuals import (  # noqa: E402
    is_annual_form,
    list_annuals,
...
from scripts.kd_research.excerpt_check import excerpt_in_text  # noqa: E402
from scripts.kd_research.gates import check_1c_year_dive_complete, complete_checks  # noqa: E402
...
class OneCComplete(unittest.TestCase):
    ...
    def test_schema_year_dive_minimal(self) -> None:
        ...
        schema = json.loads((ROOT / "templates/filing_year_dive.schema.json").read_text())
