...
## Status
Waves 1–3 implemented (2.9.0 / 2.10.0 / 2.11.0). Wave 4 destock default implemented (2.12.0): destock-in-base default; resolved-to-bear FAIL; Pair 0 GOOD is destock-in-base; 4d wins 4e on live destock; destock-inverse two-quarter WARN. Next: Wave 5 mid-cycle construction. Implementer does not flip `passes`.
