...
`cyclical` | `intangibles_sbc` | `em` | `truncation` | `sotp_users` | `growth_assets` | `macro_neutral`

## After classify

Lock the story (`registry/narrative_bind.json`) then compute. Checks: `harness/modules/valuation_checks.md`.
