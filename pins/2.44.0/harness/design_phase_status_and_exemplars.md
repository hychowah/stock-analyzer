...
0 + 1b + 1c → 1d           # 1d waits on Phase 0 (1_parallel does not)
1d → 2_parallel
2_parallel → 2_5
2_5 → 3
2_5 → 4_parallel           # 3 ‖ 4 after 2_5
3 + 4_parallel → 5
5 → done
```

Charts (phase `3`) start **after 2_5**, same as reports. Do not start `3` after `2_parallel` alone.
