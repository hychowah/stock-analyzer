...
from packages.agent_jobs.spawn import GrokSpawnBackend  # noqa: E402
from packages.research_jobs.jobs import (  # noqa: E402
...
from packages.research_jobs.prompt import (  # noqa: E402
    ALREADY_SCAFFOLDED,
    NO_LIST_SIBLINGS,
    NO_RE_SCAFFOLD,
    R2_WARNING,
...
from scripts.kd_research.ticker_lookup import FakeBackend, Quote  # noqa: E402
...
class ResearchJobsTests(unittest.TestCase):
    ...
    def test_env_archive_is_non_default(self) -> None:
        os.environ["ARCHIVE_ROOT"] = str(self.archive)
        self.assertTrue(env_archive_is_non_default(project_root=ROOT))
        os.environ.pop("ARCHIVE_ROOT", None)
        self.assertFalse(env_archive_is_non_default(project_root=ROOT))
