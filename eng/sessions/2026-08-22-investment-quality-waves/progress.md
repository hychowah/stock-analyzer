...
## Status
Waves 1–9 implemented through 2.17.0 (stop-the-plug). Persona-review prompt-law pack complete. Implementer does not flip `passes`.
...
## Verify (Waves 4–9 final)
- pytest waves 1–9 + ROIC + sector law: 148 passed
- `python scripts/eng_verify.py` PASS (VERSION 2.17.0 vs main)

## Verify (Wave 6)
- pytest `test_wave6_decision_reopen.py` + `test_wave2_decision.py`: 21 passed
- `python scripts/eng_verify.py` PASS (VERSION 2.14.0 vs main)
