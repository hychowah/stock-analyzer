...
| Damodaran catalog identities | `packages.kd_research.damodaran_gates` (≥ 3.1.0: required playbook + TV method; price column is not FV; ≥ 3.2.0: narrative substance + map to model inputs + weighted truncation + closed pricing roles + unstamped-v3 FAIL) |
