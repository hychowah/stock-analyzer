...
15b. **After Phase 2.5 is complete:** run the Agent 5 **5b** block yourself (lead). Reopen `registry/decision.json` only — do not rewrite FV, do not spawn subagent `5` in `2_5`, do not mark `2_parallel` pending. Then preflight `4_parallel` (and phase 3 charts — both wait on 2.5).
