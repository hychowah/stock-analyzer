...
from packages.kd_research.check_core import (  # re-export: tests/callers import from gates
    HOOK_REASON_MIN_LEN,
    HOOK_REQUIRED_KEYS,
    load_json,
    validate_hooks_list,
...
# Completeness paths actually checked at merge (replaces unused PHASE_COMPLETE_GLOBS).
...
# HOOK_REQUIRED_KEYS / HOOK_REASON_MIN_LEN / validate_hooks_list: check_core (re-exported).
...
def entry_checks(
    ...
    *,
    ...
    from packages.kd_research.check_catalog import run_catalog  # noqa: WPS433
...
def complete_checks(session: Path, phase_id: str) -> list[tuple[str, str, str]]:
    ...
    from packages.kd_research.check_catalog import complete_when_ids, run_catalog  # noqa: WPS433
