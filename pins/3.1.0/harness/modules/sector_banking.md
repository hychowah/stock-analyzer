...
> **KPI / stress library — not the engine.** Playbook is `financial_service` (`valuation_router.md`): equity DCF at ke (DDM / ΔT1 FCFE / excess-return). Never FCFF, WACC, or EV multiples as `fair_value.base`. P/B and P/E are the **price** column.
...
| P/E multiple | P/B, P/TBV, P/E as **price** (not fair_value.base) |
...
| Brokerages (SCHW, IBKR) | Hybrid | Interest income significant | `financial_service` (equity DCF at ke); NII in the path; commissions are still equity cash flows — not industrial FCFF |
