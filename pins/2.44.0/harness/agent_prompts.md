...
Load current policy: ROOT/harness/RESEARCH_AGENTS.md §10c (Street/Y1 + destock), §10d (ROIC), §10e (WACC). Do not restate those sections here. Do not load ROOT/harness/law_history.md (Agent 13 only when harness_version < 2.28).
...
4-street. Grade Street/Y1 + destock against RESEARCH_AGENTS.md §10c. If `harness_version < 2.28`, stop and load ROOT/harness/law_history.md — do not paste 2.7–2.27 / 2.28 Y1 into this prompt.
