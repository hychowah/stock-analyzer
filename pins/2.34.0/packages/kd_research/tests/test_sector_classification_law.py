...
SECTOR_FILES = (
    "harness/modules/sector_cyclical.md",
    "harness/modules/sector_growth.md",
    "harness/modules/sector_banking.md",
    "harness/modules/sector_insurance.md",
    "harness/modules/sector_reit.md",
    "harness/modules/sector_utility.md",
)
...
class SectorClassificationLawTests(unittest.TestCase):
    def test_cyclical_has_no_any_of_mandate(self):
        text = _read("harness/modules/sector_cyclical.md")
    ...
    def test_banking_signals_not_return_true(self):
        text = _read("harness/modules/sector_banking.md")
