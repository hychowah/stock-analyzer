...
from packages.kd_research.valuation_hygiene import check_street_hygiene
...
class StreetSchemaTests(unittest.TestCase):
    def test_unavailable_empty_years_valid(self) -> None:
        ...
        schema = json.loads((ROOT / "harness" / "schemas" / "street_estimates.schema.json").read_text(encoding="utf-8"))
