...
| **2_parallel** | 4, 5, 12 | `technical.json`, `valuation_model.json` (`shock_surface.dials` on ≥ 2.44.0), `tsr_validation.json` | FV/MOS for reports & stress; levels for technical report |
